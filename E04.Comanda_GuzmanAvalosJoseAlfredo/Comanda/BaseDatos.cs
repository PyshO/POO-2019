...
namespace Comanda
{
    class BaseDatos
    {
        ...
        {
            //Corregimos el error de la lista Menu quitando la T de List<T> y agregando Ensaladas List<Menu>
            listamenu = new List<Menu>
            ...
            //Corregimos el error de la lista ensalada quitando el List<Menu> y agregando Ensaladas List<Ensaladas>
            ...
            {
                //Aqui marcaba error ya que en la clase aperitivo el nombre no tenia bien hecho la encapsulacion
            ...
            {
                //Corregimos las comillas del Panini de pollo
